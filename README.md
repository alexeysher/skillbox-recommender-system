...
Дополнительно создан класс [Recommender](recommender.py), реализиующий полученную рекомендательную модель и интерфейс взаимодействия с нею. Для демонстрации  работы этого класса создан специальный [dashboard](main.py) с использованием фреймворка [Streamlit](https://streamlit.io/). Перед запуском dashboard необходимо установить данный фреймфорк: `pip install streamlit`.
