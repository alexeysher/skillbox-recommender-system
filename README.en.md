...
Within the dimploma, a recommendation system was developed for the online hypermarket Instacart within the framework of [competition](https://ww.kaggle.com/competitions/skillbox-recommender-system) on the platform [Kaggle](https://www.kaggle.com/).
